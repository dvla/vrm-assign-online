...
lazy val paymentSolveProject = paymentSolve("0.15-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignEligibilityProject = vrmAssignEligibility("0.12-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.13-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
