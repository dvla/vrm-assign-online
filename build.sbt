...
lazy val paymentSolveProject = paymentSolve("0.17").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignEligibilityProject = vrmAssignEligibility("0.13").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.14").disablePlugins(PlayScala, SbtWeb)
lazy val emailServiceProject = emailService("0.12").disablePlugins(PlayScala, SbtWeb)
lazy val auditProject = audit("0.9").disablePlugins(PlayScala, SbtWeb)
