...
lazy val vrmAssignEligibilityProject = vrmAssignEligibility("0.17-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.18-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val emailServiceProject = emailService("0.17-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val auditProject = audit("0.14-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
