...
libraryDependencies ++= {
  ...
  Seq(
    ...
    "dvla" %% "vehicles-presentation-common" % "2.9-SNAPSHOT" withSources() withJavadoc() exclude("junit", "junit-dep"),
    "dvla" %% "vehicles-presentation-common" % "2.9-SNAPSHOT" % "test" classifier "tests"  withSources() withJavadoc() exclude("junit", "junit-dep"),    "dvla" %% "common-test" % "2.7-SNAPSHOT" % "test" withSources() withJavadoc(),
