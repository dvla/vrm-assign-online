...
//    "com.github.detro" % "phantomjsdriver" % "1.2.0" % "test" withSources() withJavadoc(),
    ...
    "dvla" %% "vehicles-presentation-common" % "2.19.1" withSources() withJavadoc() exclude("junit", "junit-dep"),
    "dvla" %% "vehicles-presentation-common" % "2.19.1" % "test" classifier "tests"  withSources() withJavadoc() exclude("junit", "junit-dep"),
