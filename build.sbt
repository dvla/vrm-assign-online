...
// ====================== Sandbox Settings ==========================
lazy val osAddressLookupProject = osAddressLookup("0.21").disablePlugins(PlayScala, SbtWeb)
lazy val vehicleAndKeeperLookupProject = vehicleAndKeeperLookup("0.17").disablePlugins(PlayScala, SbtWeb)
lazy val paymentSolveProject = paymentSolve("0.19").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignEligibilityProject = vrmAssignEligibility("0.14").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.15").disablePlugins(PlayScala, SbtWeb)
lazy val emailServiceProject = emailService("0.14").disablePlugins(PlayScala, SbtWeb)
lazy val auditProject = audit("0.11").disablePlugins(PlayScala, SbtWeb)
