...
//    "com.github.detro" % "phantomjsdriver" % "1.2.0" % "test" withSources() withJavadoc(),
    ...
    "dvla" %% "vehicles-presentation-common" % "2.21.1" withSources() withJavadoc() exclude("junit", "junit-dep"),
    "dvla" %% "vehicles-presentation-common" % "2.21.1" % "test" classifier "tests"  withSources() withJavadoc() exclude("junit", "junit-dep"),
...
lazy val paymentSolveProject = paymentSolve("0.11").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignEligibilityProject = vrmAssignEligibility("0.8").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.7").disablePlugins(PlayScala, SbtWeb)
