...
lazy val paymentSolveProject = paymentSolve("0.22").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignEligibilityProject = vrmAssignEligibility("0.16").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.17").disablePlugins(PlayScala, SbtWeb)
lazy val emailServiceProject = emailService("0.16").disablePlugins(PlayScala, SbtWeb)
lazy val auditProject = audit("0.13").disablePlugins(PlayScala, SbtWeb)
