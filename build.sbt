...
libraryDependencies ++= {
  ...
  Seq(
    ...
    "dvla" %% "vehicles-presentation-common" % "2.9" withSources() withJavadoc() exclude("junit", "junit-dep"),
    "dvla" %% "vehicles-presentation-common" % "2.9" % "test" classifier "tests"  withSources() withJavadoc() exclude("junit", "junit-dep"),
