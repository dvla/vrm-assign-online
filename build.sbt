...
lazy val paymentSolveProject = paymentSolve("0.21-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignEligibilityProject = vrmAssignEligibility("0.16-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.17-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val emailServiceProject = emailService("0.16-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val auditProject = audit("0.13-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
