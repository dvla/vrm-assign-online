...
lazy val paymentSolveProject = paymentSolve("0.19-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignEligibilityProject = vrmAssignEligibility("0.15-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.16-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val emailServiceProject = emailService("0.14-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val auditProject = audit("0.11-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
