...
lazy val paymentSolveProject = paymentSolve("0.33-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
...
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.26-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
