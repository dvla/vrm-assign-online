...
lazy val vrmAssignEligibilityProject = vrmAssignEligibility("0.21").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.22").disablePlugins(PlayScala, SbtWeb)
