...
lazy val paymentSolveProject = paymentSolve("0.20").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignEligibilityProject = vrmAssignEligibility("0.15").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.16").disablePlugins(PlayScala, SbtWeb)
lazy val emailServiceProject = emailService("0.15").disablePlugins(PlayScala, SbtWeb)
lazy val auditProject = audit("0.12").disablePlugins(PlayScala, SbtWeb)
