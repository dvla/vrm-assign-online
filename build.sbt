...
lazy val paymentSolveProject = paymentSolve("0.32").disablePlugins(PlayScala, SbtWeb)
...
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.25").disablePlugins(PlayScala, SbtWeb)
