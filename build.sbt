...
//    "com.github.detro" % "phantomjsdriver" % "1.2.0" % "test" withSources() withJavadoc(),
    ...
    "dvla" %% "vehicles-presentation-common" % "2.17" withSources() withJavadoc() exclude("junit", "junit-dep"),
    "dvla" %% "vehicles-presentation-common" % "2.17" % "test" classifier "tests"  withSources() withJavadoc() exclude("junit", "junit-dep"),
...
lazy val paymentSolveProject = paymentSolve("0.6").disablePlugins(PlayScala, SbtWeb)
...
lazy val emailServiceProject = emailService("0.2").disablePlugins(PlayScala, SbtWeb)
