...
lazy val vrmAssignEligibilityProject = vrmAssignEligibility("0.10").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.10").disablePlugins(PlayScala, SbtWeb)
