...
lazy val paymentSolveProject = paymentSolve("0.20-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
...
lazy val auditProject = audit("0.12-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
