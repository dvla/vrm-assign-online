...
lazy val paymentSolveProject = paymentSolve("0.18-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignEligibilityProject = vrmAssignEligibility("0.14-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val vrmAssignFulfilProject = vrmAssignFulfil("0.15-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val emailServiceProject = emailService("0.13-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
lazy val auditProject = audit("0.10-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
