...
vrm_assign_vehiclelookup.refnumlabel = Rhif diweddaraf cyfeirnod dogfen tystysgrif cofrestru V5CW (llyfr log)
...
vehicle_and_keeper_lookup_document_reference_mismatch.p2 = Gwnewch yn siŵr fod y tystysgrif cofrestru V5CW (llyfr log) mwyaf diweddar gennych chi a rhowch gynnig arall arni. Ar gyfer pob rhif cofrestru cerbyd, tri chynnig yn unig a gewch i ganfod manylion y cerbyd.
