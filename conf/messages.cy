...
vrm_assign_beforeyoustart.list2item1 = rhoi rhif cofrestru ar gerbyd a gofrestrwyd yn ‘Q’ neu ‘QNI’
vrm_assign_beforeyoustart.list2item2 = wneud y cerbyd edrych yn ifancach nag ydyw
...
vrm_assign_vehiclelookup.v5c = Tystysgrif Cofrestru Cerbyd (V5C)
vrm_assign_vehiclelookup.currentVrnLabel = Rhif Cofrestru Cerbyd presennol
vrm_assign_vehiclelookup.currentVrnHint = Y rhif cofrestru y dymunwch ei newid
vrm_assign_vehiclelookup.refnumlabel = Rhif diweddaraf cyfeirnod dogfen V5C
vrm_assign_vehiclelookup.refnumHint = Y rhif 11 digid a gafwyd ar y dystysgrif gofrestru V5CW (llawlyfr) heb fylchau
...
vehicle_and_keeper_lookup_vrm_not_found.p2 = Ar gyfer pob rhif cofrestru cerbyd, tri chynnig yn unig a gewch i ganfod manylion y cerbyd.
...
vehicle_and_keeper_lookup_document_reference_mismatch.p2 = Gwnewch yn siŵr fod y V5C mwyaf diweddar gennych chi a rhowch gynnig arall arni. Ar gyfer pob rhif cofrestru cerbyd, tri chynnig yn unig a gewch i ganfod manylion y cerbyd.
vehicle_and_keeper_lookup_keeper_postcode_mismatch.title = Ni lwyddwyd i ddod o hyd i gofnod y cerbyd
vehicle_and_keeper_lookup_keeper_postcode_mismatch.p1 = Nid yw Cod Post y Ceidwad a roddwyd yn perthyn i’r V5C mwyaf diweddar a gyhoeddwyd ar gyfer y cerbyd hwn.
vehicle_and_keeper_lookup_keeper_postcode_mismatch.p2 = Gwnewch yn siŵr fod gennych chi’r cod post ar gyfer y V5C mwyaf diweddar a rhowch gynnig arall arni.
...
vehicle-lookup-failure-direct-to-paper-p2a2 = a’r V5C ynghyd â siec am y cyfanswm uchod yn daladwy i ‘DVLA Abertawe’ i:
vehicle-lookup-failure-direct-to-paper-p2b = Rhaid i chi anfon y
vehicle-lookup-failure-direct-to-paper-p2b2 = a'r V5C at:
...
vrm_assign_eligibility_v778_failure = Dengys ein cofnodion nad yw’r rhif cofrestru hwn ar Dystysgrif Gadw V778 ar hyn o bryd.  Gwiriwch y rhif cofrestru a cheisio eto.
...
vrm_assign_eligibility_destroyed_failure = Dengys ein cofnodion fod y cerbyd hwn wedi ei sgrapio.  Mae’ch cais angen asesiad pellach, cwblhewch ffurflen gais V317 a’i hanfon i’r DVLA.
vrm_assign_eligibility_not_mot_failure = Dengys ein cofnodion nad oes modd rhoi prawf MOT i’r cerbyd hwn oherwydd ei adeiladwaith neu ei ddefnydd. Ni allwch roi eich rhif cofrestru ar y cerbyd hwn. Ceir mwy o wybodaeth yn
...
vrm_assign_confirm.emailWarnp1 = Rhaid i chi ddiweddaru’ch tystysgrif cofrestru (V5C) os oes unrhyw gamgymeriadau arni, neu os gwnewch nifer o newidiadau i’ch cerbyd.
...
vrm_assign_success_payment.p7 = Byddwch angen y ffurflen V5C a ddiweddarwyd neu dystysgrif dilysu rhif cofrestru (eV948) y gallwch ei lawrlwytho a’i gadw neu ei argraffu drwy ddefnyddio’r ddolen a ddarparir.
...
email.line26 = Os nad yw’r ceidwad wedi derbyn V5C newydd o fewn 2-3 wythnos, cynghorwch y ceidwad i ffonio llinell gymorth y DVLA ar 0300 123 1350 cod 662 gyda’r ID Trafodion a restrir uchod a gwnawn ein gorau i ddatrys ei ymholiad yn gyflym.
