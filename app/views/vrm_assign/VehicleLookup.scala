...
object VehicleLookup {
  ...
  final val VehicleAndKeeperLookupResponseCodeCacheKey = "vehicle-and-keeper-lookup-response-code"
  final val VehicleAndKeeperLookupFormModelCacheKey = "vehicle-and-keeper-lookup-form-model"
  final val TransactionIdCacheKey = "transaction-Id"
